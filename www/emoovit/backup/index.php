...
<head>
	...
	<meta property="og:site_name" content="eMooVit.ai" /> <!-- eMooVit.ai -->
	<meta property="og:site" content="emoovit.ai" /> <!-- emoovit.ai -->
	<meta property="og:title" content="eMooVit.ai"/> <!-- eMooVit.ai -->
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <a class="navbar-brand logo-text page-scroll" href="index.html">eMooVit</a>

        <!-- Image Logo -->
        <!-- <a class="navbar-brand logo-image" href="index.html"><img src="images/emoovit-logo.png" alt="alternative"></a> -->
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <div class="testimonial-author">Dr. Hairi Zamzuri - CEO</div>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-7">
                    <div class="image-container">
                        <img class="img-fluid" src="images/190417-celcom-5g-autonomous-car-emoovit-04.jpg" alt="alternative">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="button-group filters-button-group">
                        ...
                        <a class="button" data-filter=".car"><span>CAR</span></a>
                        <a class="button" data-filter=".robot"><span>ROBOT</span></a>
                        <a class="button" data-filter=".marketing"><span>MARKETING</span></a>
                        <a class="button" data-filter=".seo"><span>SEO</span></a>
                    </div> <!-- end of button group -->
                    <div class="grid">
                        <div class="element-item car">
                            <a class="popup-with-move-anim" href="#project-1"><div class="element-item-overlay"><span>Proton Exora</span></div><img src="images/project-1.jpg" alt="alternative"></a>
                        </div>
                        <div class="element-item robot">
                            <a class="popup-with-move-anim" href="#project-2"><div class="element-item-overlay"><span>Proton Persona</span></div><img src="images/project-2.jpg" alt="alternative"></a>
                        </div>
                        <div class="element-item robot">
                            <a class="popup-with-move-anim" href="#project-3"><div class="element-item-overlay"><span>AMR-01</span></div><img src="images/project-3.jpg" alt="alternative"></a>
                        </div>
                        <div class="element-item robot">
                            <a class="popup-with-move-anim" href="#project-4"><div class="element-item-overlay"><span>AMR-02</span></div><img src="images/project-4.jpg" alt="alternative"></a>
                        </div>
                        <div class="element-item robot">
                            <a class="popup-with-move-anim" href="#project-5"><div class="element-item-overlay"><span>TUG ROBOT FR09-01</span></div><img src="images/project-5.jpg" alt="alternative"></a>
                        </div>
    ...
    <div id="project-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-8">
                <img class="img-fluid" src="images/project1.jpeg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Proton Exora</h3>
                ...
                <a class="btn-solid-reg" href="project/exora.php">DETAILS</a> <a class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a> 
            </div> <!-- end of col -->
        </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large">Dr Hairi Zamzuri</p>
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large">Leela Muniandy</p>
                        <p class="job-title">Human Resource Executive</p>
                        <span class="social-icons">
                            <span class="fa-stack">
                                <a href="#your-link">
                                    <span class="hexagon"></span>
                ...
                <div class="col-lg-6">
                    ...
                    <form id="contactForm" data-toggle="validator" data-focus="false">
                        ...
                        <div class="form-group checkbox">
                            <input type="checkbox" id="cterms" value="Agreed-to-Terms" required>I agree with eMooVit's stated <a href="privacy-policy.html">Privacy Policy</a> and <a href="terms-conditions.html">Terms Conditions</a> 
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="text-container about">
                        <h4>eMooVit Technology Sdn Bhd</h4>
                        <p class="white">Join a fast growing organization on robotics and autonomous vehicle with over 30 like-minded folks and counting as we forge forward in developing the latest technology to bring the future closer to us.</p>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-md-2">
                    <div class="text-container">
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Copyright © 2021 | eMooVit.ai | Powered by Aria Webtemplate</a></p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
